...
<svg viewBox="0 0 1600 750" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
  ...
  <text x="200" y="140" text-anchor="middle" fill="_labelcolor_" style="font-family:verdana;font-size:300%" ><a href="/EllipticCurve/Q/112/c/1">_curve2label_</a></text>
  ...
  <text x="800" y="140" text-anchor="middle" fill="_labelcolor_" style="font-family:verdana;font-size:300%" ><a href="/EllipticCurve/Q/112/c/3">_curve0label_</a></text>
  ...
  <text x="1400" y="140" text-anchor="middle" fill="_labelcolor_" style="font-family:verdana;font-size:300%" ><a href="/EllipticCurve/Q/112/c/4">_curve4label_</a></text>
  ...
  <text x="200" y="640" text-anchor="middle" fill="_labelcolor_" style="font-family:verdana;font-size:300%" ><a href="/EllipticCurve/Q/112/c/6">_curve3label_</a></text>
  ...
  <text x="800" y="640" text-anchor="middle" fill="_labelcolor_" style="font-family:verdana;font-size:300%" ><a href="/EllipticCurve/Q/112/c/2">_curve1label_</a></text>
  ...
  <text x="1400" y="640" text-anchor="middle" fill="_labelcolor_" style="font-family:verdana;font-size:300%" ><a href="/EllipticCurve/Q/112/c/5">_curve5label_</a></text>
...
#    the_conductor = isogeny_class.conductor
    ...
    # First we have to find which graph we have.
        ...
        this_graph = this_graph.replace("_degree20_", str(isogeny_matrix[curve_map[2]][curve_map[0]])) # usually 2
        ...
        for j in range(6):
            ...
            this_graph = this_graph.replace("_curve" + str(j) + "omega" + "_", str(isogeny_class.curves[curve_map[j]]['real_period'])[:5]+"...")
...
<svg viewBox="1000 750 800 150" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
  ...
  <text x="1541.0" y="888.0" text-anchor="end" fill="#000" style="font-family:verdana;font-size:200%" >Tor</text>
