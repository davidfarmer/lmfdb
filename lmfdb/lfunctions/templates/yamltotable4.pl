...
-->
<td align="center">\$(\\nu_1,\\nu_2), \\mu \$</td>
<td align="center">\$(\\delta_1,\\delta_2), (\\mu_1,\\mu_2)\$</td>
<td align="center">\$\\delta_1,\\delta_2,\\delta_3,\\delta_4\$</td>
<td align="center">\$\\mu_1,\\mu_2,\\mu_3\$</td>
...
if(my $tmp=$rowvals{deltaRRRR}) {

   $tmp =~s/\[//;
   $tmp =~s/\]//;

   $rowvals{deltaRRRR}=$tmp;
}

if(my $tmp=$rowvals{muRRC}) {
...
#if($rowvals{deltaRC}) {
print OUTFILE "<td>".$rowvals{nuCC}.",".$rowvals{muCC}."</td>";
#}
#else {
#print OUTFILE "<td>"."</td>";
#}
print OUTFILE "<td>".$rowvals{deltaRRC}.$rowvals{nuRRC}.", ".$rowvals{muRRC}."</td>";
print OUTFILE "<td>".$rowvals{deltaRRRR}."</td>";
print "About to trim digits from ",$rowvals{muRRRR},"\n\n";
print OUTFILE "<td>".trimdigits($rowvals{muRRRR})."</td>";
